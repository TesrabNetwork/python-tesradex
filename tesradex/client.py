...
class Client(object):
    ...
    def get_order_book(self, symbol, group=None, limit=None):
        ...
        .. code:: python
            ...
            orders = client.get_order_book('TDEX-BTC', limit=50)
    ...
    def get_sell_orders(self, symbol, group=None, limit=None):
        ...
        .. code:: python
            ...
            orders = client.get_sell_orders('TDEX-BTC', limit=50)
    ...
    def get_trading_symbols(self, market=None):
        ...
        .. code:: python
            ...
            coins = client.get_trading_symbols('TDEX)
    ...
    def get_kline_data_tv(self, symbol, resolution, from_time, to_time):
        ...
        .. code:: python
            ...
            klines = client.get_kline_data_tv('TDEX-BTC', Client.RESOLUTION_1MINUTE, 1507479171, 1510278278)
